...
export default function Navbar() {
  return (
    <div>
      <div className="navbar bg-base-100 md:max-w-screen-2xl max-w-md container md:mx-auto md:px-10 px-1 fixed top-0 left-0 right-0 z-40 bg-opacity-70 shadow-lg">
